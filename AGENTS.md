...
Read [spec](docs/specs/pi-session-inspector-v1.md) and [implementation plan](docs/plans/pi-session-inspector-v1-implementation.md) before modifying code.
...
3. No prompt, response, raw tool args/results, provider payload, secret, or arbitrary producer string enters Inspector WAL/report diagnostics.
...
9. Version are semver. Agent needs to update a version before the release of a new feature.
