...
if(data.toolFilter!==undefined){toolFilters[viewIdentity()]=data.toolFilter;render();return;}if(data.clearFilter!==undefined){toolFilters[viewIdentity()]=null;render();return;}if(data.envTab!==undefined)setViewSetting("envTab",data.envTab);});
