...
const HELP_LINES: readonly string[] = Object.freeze([
  ...
  "Options:",
  `  ui        ${INSPECTOR_OPTIONS.ui[0]} active|tree; --theme dark|light; --no-open`,
  `  snapshot  ${INSPECTOR_OPTIONS.snapshot.join(" ")}`,
  `  --preset ${INSPECTOR_PRESET_VALUES.join("|")}; --from DATE --to DATE`,
